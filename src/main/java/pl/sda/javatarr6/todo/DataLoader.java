...
//        userRepository.save(user2);
        ...
        ZadanieEntity zadanieEntity2 = new ZadanieEntity("ToDo cos tam",new Date(), null, new Boolean(false),new User(2L) );
        ...
        ZadanieEntity zadanieEntity4 = new ZadanieEntity("Nowe Zadanie",new Date(), null , new Boolean(false),new User(2L) );
